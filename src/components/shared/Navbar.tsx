...
export function Navbar() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 glass-panel border-b border-outline-variant/10 shadow-ambient">
            ...
            <div className="flex items-center gap-2">
              {isAuthenticated ? (
                <>
                  ...
                  >
                    <Heart className="w-[18px] h-[18px] text-on-surface" />
                  </Link>
                  <button
                  ...
                  {showUserMenu && (
                    <div
                      className="absolute right-6 top-16 w-56 bg-surface-container-lowest rounded-xl shadow-ambient-lg py-2 z-50 border border-outline-variant/10"
                    ...
                    >
                      ...
                      <div className="border-t border-outline-variant/10 mt-1 pt-1">
                        <button
                          ...
                          className="w-full text-left px-4 py-2.5 text-sm text-primary hover:bg-surface-container-low transition-colors font-semibold"
                        >
                          Log out
                        </button>
                      </div>
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-[60] md:hidden">
          ...
          />
          <div className="absolute right-0 top-0 bottom-0 w-80 bg-surface-container-lowest shadow-ambient-lg p-6 border-l border-outline-variant/10">
            ...
            <div className="flex flex-col gap-4">
              {!isAuthenticated ? (
                ...
                <>
                  <Link
                    to="/dashboard/trips"
                    className="px-4 py-3 text-sm font-medium hover:bg-surface-container-low rounded-lg"
                    onClick={closeMobileMenu}
                  >
                    My Trips
                  </Link>
