...
export function Privacy() {
  ...
  useEffect(() => {
    const fetchCms = async () => {
      try {
        const response = await api.get<{ title: string; content: string; isActive: boolean }>('/cms/slug/privacy');
  ...
  return (
    <LegalLayout
      ...
      subtitle={cmsContent ? "Dynamic platform policy details." : "Last updated: October 24, 2024. Your privacy is our highest standard."}
    >
      {cmsContent ? (
